...
const NewArrival = () => {
  return (
    <div className="bg-rose-100  px-2 pb-5">
      <hr className="border-2 border-green-500"/>
      <div className="w-full text-2xl sm:text-3xl lg:text-4xl font-bold mb-8 bg-green-100 text-green-500 text-center font-mono px-6 mx-auto py-4">
        New Arrivals...
      </div>

      <section
        id="Projects"
        className=" grid grid-cols-2 sm:grid-cols-2 md:gap-6 md:grid-cols-3 gap-2 p-2 mt-2"
      >
        {products.map((product) => (
          <div
            key={product.id}
            className="w-full bg-white shadow-md rounded-xl duration-500 hover:md:scale-105 hover:shadow-xl"
            >
              <a href="#">
                <img
                  src={product.image}
